      ...
      >
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <motion.div variants={itemVariants} className="mb-8">
            <Link href="/services" className="inline-flex items-center text-sm font-medium text-primary-foreground/80 hover:text-primary-foreground transition-colors">
          ...
          <div className="text-center">
            ...
            <motion.h1 variants={itemVariants} className="text-4xl md:text-6xl font-bold mb-6 text-primary-foreground">
              {title}
            </motion.h1>
            <motion.p variants={itemVariants} className="text-lg text-primary-foreground/90 max-w-3xl mx-auto leading-relaxed">
              {longDescription}
            </motion.p>
          </div>
        </div>
                ...
                <motion.div key={project.id} variants={itemVariants}>
                  <Card className="group overflow-hidden transition-all duration-300 h-full flex flex-col glassmorphism hover-glow">
                    <CardContent className="p-0 flex flex-col flex-grow">
                      <div className="relative overflow-hidden aspect-video rounded-t-lg" key={index}>
                        <Image
