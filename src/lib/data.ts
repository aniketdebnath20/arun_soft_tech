...
export const services: Service[] = [
  { id: 1, icon: Code, title: "Web Development", description: "Crafting high-performance, scalable web applications with modern architecture.", gradient: "from-blue-500 to-cyan-500", details: ["Custom web apps", "E-commerce platforms", "API development", "CMS solutions"] },
  { id: 2, icon: Smartphone, title: "Mobile App Development", description: "Building intuitive and engaging native and cross-platform mobile experiences.", gradient: "from-purple-500 to-pink-500", details: ["iOS & Android apps", "React Native development", "App maintenance", "UI/UX integration"] },
  { id: 3, icon: Palette, title: "UI/UX Design", description: "Designing beautiful, user-centric interfaces that drive engagement and conversion.", gradient: "from-pink-500 to-rose-500", details: ["User research", "Wireframing & Prototyping", "Interaction design", "Usability testing"] },
  { id: 4, icon: Cloud, title: "Cloud & DevOps", description: "Architecting robust cloud infrastructure and CI/CD pipelines for optimal performance.", gradient: "from-green-500 to-emerald-500", details: ["Cloud migration", "CI/CD pipelines", "Infrastructure as Code", "Containerization"] },
  { id: 5, icon: Shield, title: "Security & Audits", description: "Ensuring your applications are secure, compliant, and resilient against threats.", gradient: "from-red-500 to-pink-500", details: ["Penetration testing", "Code reviews", "Compliance checks", "Threat modeling"] },
  { id: 6, icon: BrainCircuit, title: "AI & Machine Learning", description: "Leveraging AI to build intelligent applications that automate and innovate.", gradient: "from-amber-500 to-orange-500", details: ["Custom ML models", "Natural Language Processing", "Computer Vision", "Data analysis"] },
];
